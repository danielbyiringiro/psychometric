    ...
    <div className='min-h-screen bg-gray-100 py-12 px-4'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid md:grid-cols-3 gap-6'>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            <h2 className="text-2xl font-semibold text-gray-700 mb-4 text-center">Abstract Reasoning</h2>
            <Link href="/abstract" className="block w-full bg-yellow-500 text-white text-center py-3 px-6 rounded-md hover:bg-yellow-600 transition-colors">
              Start Test
            </Link>
          </div>
        </div>
